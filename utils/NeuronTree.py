...
from .utils import angle_between, get_rotation_matrix, rotationMatrixToEulerAngles
...
class NeuronTree:
    ...
    def __init__(self, swc=None, scaling=1., node_data=[], edge_data=[], graph=None, post_process=False):
        """
    ...
    def get_branch_order(self):
        ...
        """
        return self._get_branch_order(self.get_root(), 0)
    ...
    def get_psad(self):
        ...
        :return:
            ...
            psad:   dict, dictionary of the form {bp: PSAD} for each branch point in neuron.
    ...
    def get_persistence(self, f=None):
        ...
        :return: pandas.DataFrame with entries node_id | birth | death . Where birth and death are defined in radial
            distance from soma by default or are computed according to the function passed via f.
        """
...
#######################################################################################################################
    ...
    def draw_2D(self, fig=None, projection='xz', axon_color='grey', dendrite_color='darkgrey',
                apical_dendrite_color='yellow', x_offset=0, y_offset=0, **kwargs):
        """
